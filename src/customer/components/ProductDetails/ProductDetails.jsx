...
import ProductReviewFile from "./ProductReviewFile";
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              ...
              <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-1">
                Casual puff Sleaves solid women white top
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                    ...
                    <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">5890 Reviews</p>
                </div>
              </div>
            ...
            <Grid container spacing={7}>
              <Grid item xs={7}>
                <div className="space-y-5">
                   {[1,1,1].map((item)=><ProductReviewFile></ProductReviewFile>)}
                </div>
              </Grid>
              <Grid item xs={5}>
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <p className="opacity-60">54609 Ratings</p>
                    </div>
                    <Box>
